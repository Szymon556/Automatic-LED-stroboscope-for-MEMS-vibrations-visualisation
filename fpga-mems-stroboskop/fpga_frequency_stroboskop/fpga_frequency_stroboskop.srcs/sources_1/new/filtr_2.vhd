...
architecture Behavioral of filtr_2 is
   ...
   constant b0 : coeff := to_sfixed(8.766e-05,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT); 
   constant b1 : coeff := to_sfixed(0.0001753,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   constant b2 : coeff := to_sfixed(8.766e-05,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   
 
   constant a1 : coeff := to_sfixed(1.973 ,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   constant a2 : coeff := to_sfixed(-0.9737 ,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
