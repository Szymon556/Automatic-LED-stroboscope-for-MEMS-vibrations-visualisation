...
architecture Behavioral of filtr_1 is
   ...
   constant b0 : coeff := to_sfixed(9.506e-05,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT); 
   constant b1 : coeff := to_sfixed(0.0001901,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   constant b2 : coeff := to_sfixed(9.506e-05,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   

   constant a1 : coeff := to_sfixed(1.972 ,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
   constant a2 : coeff := to_sfixed(-0.9726,INTEGER_BITS_COEFFICIENT - 1, FRACTION_BITS_COEFFICIENT);
    ...
    begin
        ...
        case state_reg is
            ...
            when done =>
                done_tick <= '1';
                state_next <= idle;
                helper_buff_next <= input_reg; -- czyli zachowaj input_reg dla reg_1
        end case;
    end process;
    Yn <= buff_yn;
end Behavioral;